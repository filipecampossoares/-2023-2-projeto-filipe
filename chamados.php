              ...
              <!-- Inicio tabela -->
                   ...
                   ?>
                       ...
                       <td><?=$agenda['retorno']?></td>
												...
												<input type="hidden" class="form-control" name="dt_fechamento" value="<?php date_default_timezone_set('America/Sao_Paulo'); echo date('d/m/Y') ?>">
                        <input type="hidden" class="form-control" name="fechado" value="<?php echo $_SESSION['usuario']; ?>">
												...
												<button type="submit" onclick="return confirm('Tem certeza que deseja atualizar este chamado?')" class="btn-primary">Retornar</button>
													</form>
												</td>
											</tr>
									<?php
